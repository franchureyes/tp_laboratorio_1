...
{
	int retorno = -1;
	char apellidoAuxUno[TAMNOMBRES];
	char nombreAuxUno[TAMNOMBRES];
	char apellidoAuxDos[TAMNOMBRES];
	char nombreAuxDos[TAMNOMBRES];
...
{
	int retorno = -1;
	char codigoVueloAuxUno[TAMDATOS];
	char codigoVueloAuxDos[TAMDATOS];
